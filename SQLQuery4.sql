...
/************************************
	Consulta No.1 Listar el top 5 de las entidades con m�s casos confirmados por cada uno de los a�os 
...
/************************************
	Consulta No.10  Listar el porcentaje de casos confirmado por g�nero en los a�os 2020 y 2021.  
	Significado de los valores de los catalogos: 
	Responsable: Macias Galvan Arturo Daniel
	Comentarios: 
...
AND YEAR(TRY_CAST(dc.FECHA_INGRESO AS DATE)) IN (2020, 2021)
GROUP BY ce.entidad, YEAR(TRY_CAST(dc.FECHA_INGRESO AS DATE))
ORDER BY ce.entidad, A�o;
>>>>>>> arturo


/************************************
	Consulta No.13  Listar porcentajes de casos confirmados por g�nero en el rango de edades de 20 a 30 a�os, 
